...
CeldaDiana matrizDiana[7][10] = {
  {{2, 'T'}, {15, 'T'}, {10, 'T'}, {6, 'T'}, {17, 'T'}, {3, 'T'}, {13, 'T'}, {4, 'T'}, {18, 'T'}, {1, 'T'}},
  {{2, 'D'}, {15, 'D'}, {10, 'D'}, {6, 'D'}, {17, 'D'}, {3, 'D'}, {13, 'D'}, {4, 'D'}, {18, 'D'}, {1, 'D'}},
  {{2, 'S'}, {15, 'S'}, {10, 'S'}, {6, 'S'}, {17, 'S'}, {3, 'S'}, {13, 'S'}, {4, 'S'}, {18, 'S'}, {1, 'S'}},
  {{0, 'D'}, {0, 'S'}, {0, 'S'}, {0, 'S'}, {0, 'D'}, {0, 'S'}, {0, 'T'}, {0, 'S'}, {25, 'S'}, {25, 'D'}},
  {{16, 'S'}, {8, 'S'}, {11, 'S'}, {14, 'S'}, {7, 'S'}, {19, 'S'}, {9, 'S'}, {12, 'S'}, {5, 'S'}, {20, 'S'}},
  {{16, 'D'}, {8, 'D'}, {11, 'D'}, {14, 'D'}, {7, 'D'}, {19, 'D'}, {9, 'D'}, {12, 'D'}, {5, 'D'}, {20, 'D'}},
  {{16, 'T'}, {8, 'T'}, {11, 'T'}, {14, 'T'}, {7, 'T'}, {19, 'T'}, {9, 'T'}, {12, 'T'}, {5, 'T'}, {20, 'T'}}
};

// Variable para almacenar el tiempo de inicio del barrido
//unsigned long tiempoInicioBarrido = 0;
...
void loop() {
  //tiempoInicioBarrido = micros(); // Guarda el tiempo de inicio del barrido
  for (int i = 0; i < numSalidaPinesDigitales; ++i) {
  ...
  //unsigned long duracionBarrido = micros() - tiempoInicioBarrido;
  //Serial.println(duracionBarrido);
}
